...
static const unsigned int A = 0x67452301;
static const unsigned int B = 0xefcdab89;
static const unsigned int C = 0x98badcfe;
static const unsigned int D = 0x10325476;
...
public:
    ...
    // Murmur3哈希函数
    uint murmur3(const char *key, size_t len, uint seed)
    {
        uint32_t h = seed;
        if (len > 3)
        {
